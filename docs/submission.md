...
| Codex Sites | Serve the no-sign-in sample preview on chatgpt.site | Packaging in progress; publication pending |
...
| --- | --- |
| Name | Marginfield |
| Public GitHub repository | Pending — public GitHub publication authorized |
| Public app | Pending — selected host is chatgpt.site |
...
Both **convex.site and chatgpt.site** are accepted. Marginfield uses **chatgpt.site** for its public sample preview. The Convex static-hosting component remains in source for a later connected release; it is not the selected preview host. The public GitHub repository,
hosted product, short video and social post remain required external work.
...
No live provider call, sent email, public deployment, remote CI run, or successful
submission is claimed. Canonical component-aware Convex code generation still
